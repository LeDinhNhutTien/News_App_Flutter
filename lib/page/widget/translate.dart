...
class Translator extends StatefulWidget {
  ...
  @override
  State<Translator> createState() => _TranslatorAppState();
}

class _TranslatorAppState extends State<Translator> {
  ...
  String from = 'en';
  String to = 'vi';
  String data = 'Bạn có khỏe không?';
  String selectedvalue = 'English';
  String selectedvalue2 = 'Vietnamese';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        flexibleSpace: Container(
            decoration: const BoxDecoration(
              color: Color.fromARGB(255, 207, 218, 234),
            )),
        title: const Text(
          'Translate',
          style: TextStyle(
      ...
      backgroundColor: const Color.fromARGB(255, 246, 246, 250),
