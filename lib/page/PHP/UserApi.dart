...
Future<List<User>> fetchDataDBUser() async {
  try {
    final url = Uri.parse('http://172.22.208.1/server/getAllUser.php');
...
Future<void> saveUser(User user) async {
  var url = Uri.parse('http://172.22.208.1/server/saveUser.php');
...
Future<void> deleteUser(User user) async {
  var url = Uri.parse('http://172.22.208.1/server/deleteUser.php');
...
Future<void> updateUser(User user, String oldEmail) async {
  var url = Uri.parse('http://172.22.208.1/server/updateUser.php');
